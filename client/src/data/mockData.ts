...
export interface Flight {
  ...
  duration: string;
  stops: number;
  layovers: string[]; // List of airports where layovers occur
  basePrice: number;   // Agent Net base price
...
export interface LedgerTransaction {
  ...
  ref: string;
  date: string;
  type: 'Deposit' | 'Issue Ticket' | 'Void Ticket' | 'Refund';
  description: string;
  amount: number;
  balanceAfter: number;
...
// Seed relative dates to make flights feel fresh
...
export const MOCK_LEDGER: LedgerTransaction[] = [
  ...
  },
  {
    ...
    amount: -50500, // base price 42k + tax 8.5k
    balanceAfter: 449500,
    status: 'Success',
  },
  {
    ...
    amount: -47100, // base price 38k + tax 9.1k
    balanceAfter: 402400,
    status: 'Success',
  },
  {
    ...
    amount: 43100, // refund after penalty
    balanceAfter: 445500,
    status: 'Success',
  },
  {
